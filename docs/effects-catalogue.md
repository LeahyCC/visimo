...
| id             | kind | what you see                                                                   | how                                                        | music                      | moments | tension does                          | cost   | tier | status                             |
| -------------- | ---- | ------------------------------------------------------------------------------ | ---------------------------------------------------------- | -------------------------- | ------- | ------------------------------------- | ------ | ---- | ---------------------------------- |
| `murmuration`  | ink  | thousands of birds moving as one body, folding and splitting on the beat       | swarm-kit, points, scatter on hits                         | DnB, IDM, orchestral       | G B D   | the flock balls up tight, then bursts | medium | S    | claimed: feature/study-murmuration |
