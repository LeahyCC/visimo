...
| `chroma-rows`    | the twelve note strengths appended to the END of the packet (`docs/open-leads.md` has this as the blocker for chord petals) | chord-petals, cymatics, mandala, stained-glass, harmonograph, sacred-lines, constellation | built  |
