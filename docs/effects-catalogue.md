...
| `black-hole` | flow | the whole picture bends round a dark disc with a burning ring. Bass feeds the ring                  | lens warp of the canvas plus one ring ink                 | dubstep, bass, doom      | B D     | disc grows, pull strengthens      | medium | S    | claimed: feature/study-black-hole |
