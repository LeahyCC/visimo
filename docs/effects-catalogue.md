...
| `lightning` | ink  | branching bolts on the biggest hits, afterglow hangs in the canvas                         | recursive midpoint branches on CPU, line quads, flash safe | metal, dubstep, DnB          | D       | none. Held back, fires on impact      | cheap  | S    | claimed: feature/study-lightning |
...
| `lasers`        | ink  | club laser fans sweeping through haze, on the beat                                                 | analytic beams with soft falloff, angle from beatPhase    | house, trance, techno     | G D     | fans close to a single beam      | cheap  | S    | open   |
