...
| id              | kind | what you see                                                                                       | how                                                              | music                     | moments | tension does                     | cost   | tier | status                          |
| --------------- | ---- | -------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- | ------------------------- | ------- | -------------------------------- | ------ | ---- | ------------------------------- |
| `cymatics`      | ink  | sand on a vibrating plate. The pattern is set by the notes actually playing. You see the sound     | Chladni modes summed from the chroma rows, one per sounding note | any tonal music           | I G R   | pattern sharpens to thin lines   | cheap  | S    | claimed: feature/study-cymatics |
