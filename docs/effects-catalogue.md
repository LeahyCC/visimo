...
| `grid-3d`       | ink  | a neon grid floor to the horizon that ripples with the bass                                        | height-kit as grid lines only                             | synthwave, house, electro | G B     | grid rushes toward you           | cheap  | S    | claimed: feature/study-grid-3d |
