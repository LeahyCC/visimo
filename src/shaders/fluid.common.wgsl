...
/** How many of the splat slots this frame filled. Clamped, since it arrives
 * as a float a mapping may have pushed anywhere. */
fn liveEmitters() -> u32 {
  return min(u32(max(sim.mix.z, 0.0)), MAX_EMITTERS);
}
