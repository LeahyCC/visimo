...
export const LASERS: InkStudy = {
  ...
  mapping: [
    ...
    { from: 'tempoConfidence', to: 'intensity', gain: -1.6, curve: 'invert' },
    { from: 'energy', to: 'intensity', gain: 0.5, curve: 'linear' },
    ...
    { from: 'energy', to: 'haze', gain: 0.08, curve: 'linear' },
    { from: 'bassPulse', to: 'haze', gain: 0.06, curve: 'linear' },
  ],
  cost: 'cheap',
}
